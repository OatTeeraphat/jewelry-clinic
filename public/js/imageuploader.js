...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function (options, refreshMode) {
            ...
            self.$errorContainer = $h.getElement(options, 'elErrorContainer', self.$previewContainer.find('.kv-fileinput-errors'));
        ...
        _errorsExist: function () {
            ...
            $err.find('.kv-errors-close').remove();
            $err.find('ul').remove();
        ...
        _addError: function (msg) {
            ...
            if (msg && $error.length) {
                ...
                self._handler($error.find('.kv-errors-close'), 'click', function () {
                    setTimeout(function() {
        ...
        _setValidationError: function (css) {
            var self = this;
            css = (css ? css + ' ' : '') + 'has-errors';
            self.$container.removeClass(css).addClass('has-errors');
            $h.addCss(self.$captionContainer, 'is-invalid');
        },
        _resetErrors: function (fade) {
            var self = this, $error = self.$errorContainer;
            self.isError = false;
            self.$container.removeClass('has-errors');
        ...
        _initClickable: function () {
            ...
            self._handler($zone, 'click', function (e) {
                var $tar = $(e.target);
                if (!$zone.find('.kv-fileinput-errors:visible').length &&
                ...
                if ($h.isEmpty(data) || $h.isEmpty(data.error)) {
                    ...
                    if (self.showPreview) {
                        $thumbs.each(function () {
                            ...
                            if (!$thumb.hasClass('file-preview-errors') || self.retryErrorUploads) {
                                key++;
                            }
                        });
                        self._initUploadSuccess(data);
        ...
        _initFileActions: function () {
            ...
            self.getFrames(' .kv-file-remove').each(function () {
                ...
                self._handler($el, 'click', function () {
                    ...
                    hasError = $frame.hasClass('file-preview-errors');
                    $h.cleanMemory($frame);
            ...
            self.getFrames(' .kv-file-upload').each(function () {
                ...
                self._handler($el, 'click', function () {
                    ...
                    self.$progress.hide();
                    if ($frame.hasClass('file-preview-errors') && !self.retryErrorUploads) {
                        return;
                    }
        ...
        _setThumbStatus: function ($thumb, status) {
            ...
            $thumb.removeClass('file-preview-success file-preview-errors file-preview-loading');
            if (status === 'Success') {
    ...
    $.fn.fileinput.defaults = {
        ...
        msgErrorClass: 'file-errors-message',
        ...
        errorCloseButton: $h.closeButton('kv-errors-close'),
        slugCallback: null,
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooSmall: 'ไฟลล์มีขนาด "{name}" (<b>{size/1000} MB</b>) มีขาดเล็กว่าที่กำหนด<b>{minSize} KB</b>.',
        msgSizeTooLarge: 'ไฟลล์มีขนาด "{name}" (<b>{size/1000} MB</b>) มีขนาดใหญ่กว่าที่กำหนด<b>{minSize/1000} KB</b>.',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        msgFilesTooMany: 'สามารถเพิ่มรูปได้มากที่สุด <b>{m}</b> รูป',
        ...
        msgInvalidFileType: 'รองรับเฉพาะไฟลล์รูปภาพ "{types}" เท่านั้น',
        ...
        msgAjaxError: 'ขาดการติดต่อกับ server',
        ...
        dropZoneTitle: 'ลากรูปภาพมาวาง หรือ กดปุ่ม "เพิ่มรูป"',
